...
QUICK_REASONS: tuple[str, ...] = ("бой", "порча", "недостача", "пересортица", "истёк срок")

# Причина строк, созданных проведением пересчёта. Одна на обе стороны: в ленте
# видно, что запись родилась из инвентаризации, а не из решения человека.
COUNT_REASON = "инвентаризация"
