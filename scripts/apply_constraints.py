...
def _checks() -> list[Check]:
    ...
    return [
        ...
        Check("stock_transfers_quantity_chk", "stock_transfers", "quantity > 0",
              ("id", "product_id", "quantity"), "перемещение склад-склад > 0"),
        Check("stock_transfers_diff_wh_chk", "stock_transfers",
              "from_warehouse_id <> to_warehouse_id",
              ("id", "from_warehouse_id", "to_warehouse_id"),
              "перемещение обязано менять склад"),
...
FOREIGN_KEYS: list[ForeignKey] = [
    ...
    ForeignKey("stock_transfers_product_fk", "stock_transfers", "product_id", "products"),
    ForeignKey("stock_transfers_from_wh_fk", "stock_transfers", "from_warehouse_id",
               "warehouses"),
    ForeignKey("stock_transfers_to_wh_fk", "stock_transfers", "to_warehouse_id", "warehouses"),
    ForeignKey("warehouse_archived_wh_fk", "warehouse_archived", "warehouse_id", "warehouses"),
    ForeignKey("order_warehouse_order_fk", "order_warehouse", "order_id", "orders"),
    ForeignKey("order_warehouse_wh_fk", "order_warehouse", "warehouse_id", "warehouses"),
