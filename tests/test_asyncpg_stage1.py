...
# ─── Stage 7: get_overdue_undeposited_orders ─────────────────────────────────
# get_payments_report удалён: вызывающих не осталось (бот /payreport вырезан).


def test_get_overdue_undeposited_orders_async(isolated_db):
    db = isolated_db
